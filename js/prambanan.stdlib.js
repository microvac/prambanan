(function(prambanan) {
	...
	__builtin__ = prambanan.import('__builtin__');min = __builtin__.min;int = __builtin__.int;__import__ = __builtin__.__import__;float = __builtin__.float;enumerate = __builtin__.enumerate;abs = __builtin__.abs;max = __builtin__.max;
	...
	_m___pyjamas__ = __import__('__pyjamas__'); JS = _m___pyjamas__.JS;  
	ceil = function (x) {
	...
	fsum = function (x) {
		...
		xx =  (function(){ 
			...
			_results = []; _list = _iter(enumerate(x));
	...
	hypot = function (x, y) {
		x = abs(x);
		y = abs(y);
		(function(_source){x = _source[0]; y = _source[1]; })([max(x, y), min(x, y)]);
...
(function(prambanan) {
	...
	__builtin__ = prambanan.import('__builtin__');object = __builtin__.object;int = __builtin__.int;__import__ = __builtin__.__import__;float = __builtin__.float;len = __builtin__.len;TypeError = __builtin__.TypeError;str = __builtin__.str;NotImplementedError = __builtin__.NotImplementedError;isinstance = __builtin__.isinstance;ValueError = __builtin__.ValueError;
	...
	function t_time_struct_time(){ this.__init__.apply(this, arguments); }
 	struct_time = object.extend({constructor: t_time_struct_time,
		n_fields: 9,
		n_sequence_fields: 9,
		n_unnamed_fields: 0,
		tm_year: null,
...
(function(prambanan) {
	...
	__builtin__ = prambanan.import('__builtin__');TypeError = __builtin__.TypeError;int = __builtin__.int;__import__ = __builtin__.__import__;object = __builtin__.object;NotImplementedError = __builtin__.NotImplementedError;isinstance = __builtin__.isinstance;
	...
	_m___pyjamas__ = __import__('__pyjamas__'); JS = _m___pyjamas__.JS;  
	_m_time = __import__('time'); __c__days = _m_time.__c__days;  __c__months = _m_time.__c__months;  strftime = _m_time.strftime;  localtime = _m_time.localtime;  gmtime = _m_time.gmtime;  _strptime = _m_time._strptime;  
	MINYEAR = 1;
	...
	function t_datetime_date(){ this.__init__.apply(this, arguments); }
 	date = object.extend({constructor: t_datetime_date,
	...
	function t_datetime_time(){ this.__init__.apply(this, arguments); }
 	time = object.extend({constructor: t_datetime_time,
	...
	function t_datetime_datetime(){ this.__init__.apply(this, arguments); }
 	datetime = date.extend({constructor: t_datetime_datetime,
	...
	function t_datetime_timedelta(){ this.__init__.apply(this, arguments); }
 	timedelta = object.extend({constructor: t_datetime_timedelta,
	...
	function t_datetime_tzinfo(){ this.__init__.apply(this, arguments); }
 	tzinfo = object.extend({constructor: t_datetime_tzinfo/* pass */
	});
