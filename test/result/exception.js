(function (prambanan) {
    var __builtin__, __py_file__, _ex, _ex1, _ex2, _ex3, _ex4, _throw, b, c, print;
    ...
    try{a = 3;} catch (_ex) {
        if (_ex instanceof BaseException) {
            print("a");
        } else{_throw(_ex, __py_file__, 1);}
    }
    try{a = 3;} catch (_ex1) {
        if (_ex1 instanceof BaseException) {
            b = _ex1;
            print(a.message);
        } else{_throw(_ex1, __py_file__, 6);}
    }
    try{a = 3;} catch (_ex2) {
        if (_ex2 instanceof BaseException) {
            ...
            c = _ex2;
            print(c.message);
        } else{_throw(_ex2, __py_file__, 11);}
    }
    try{a = 3;} catch (_ex3) {
